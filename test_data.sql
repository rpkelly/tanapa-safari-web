...
INSERT INTO safari(name, description, header_media_id, footer_media_id)
VALUES('Arusha Safari', 'Tour Arusha park.', @arusha_safari_header_media_id, @arusha_safari_footer_media_id);
